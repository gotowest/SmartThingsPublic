...
preferences {
    input("username", "text", title: "Username", description: "gary@westgang.com")
    input("password", "password", title: "Password", description: "Z!oVcK8w,8sqqcxBm,N")
    input("mac", "text", title: "MAC Address", description: "18b430000038a1e0")
}
 

metadata {
	// Automatically generated. Make future change here.
	definition (name: "Nest Protect - Bedroom Master Sitting Room", namespace: "NP", author: "jcbannon") {
